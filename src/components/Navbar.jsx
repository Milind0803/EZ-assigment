        ...
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center">
            <Link to="/" className="flex items-center gap-2">
              <img
                src="/src/assets/VFilms Logo.png"
                alt="logo"
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link to="/branding" className="text-gray-700 hover:text-gray-900">
              Branding
            </Link>
            <Link
              to="/art-curation"
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-gray-100">
          <div className="px-4 pt-2 pb-4 space-y-1">
            ...
            <Link to="/film-production" className="block py-2">
              Film Production
            </Link>
            <Link to="/branding" className="block py-2">
              Branding
            </Link>
            <Link to="/art-curation" className="block py-2">
              Art Curation
            </Link>
            <Link to="/portfolio" className="block py-2">
              Portfolio
            </Link>
            ...
            <Link
              to="/contact"
              className="block py-2 text-white bg-blue-600 text-center rounded-md"
            >
              Contact
            </Link>
          </div>
